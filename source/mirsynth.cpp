...
MirSynth::MirSynth ()
: DISTRHO::Plugin (kNumParams, 0, 0)	// TODO: Implement program support
{
#if 0	// AnClark MOD: Now they are in fixed size!
...
//-----------------------------------------------------------------------------------------
void MirSynth::setProgramName (const char* name)
{
...
//-----------------------------------------------------------------------------------------
float MirSynth::getParameter (VstInt32 index) const
{
	return Glob->parameters[index]->value;
}

//-----------------------------------------------------------------------------------------
#if 0	// Not used by DPF
