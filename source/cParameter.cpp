...
void cParameter::getName(char* text)
{
	switch(type)
	{
		...
		case kParamLfoRange:		sprintf(text, "l%i range", compId);break;
		case kParamLfoRate:			sprintf(text, "l%i rate", compId);break;
		case kParamLfoPhase:		sprintf(text, "l%i phase",compId);break;
		case kParamLfoFade:			sprintf(text, "l%i fade", compId);break;
		case kParamLfoDelay:		sprintf(text, "l%i delay",compId);break;
		case kParamLfoWaveform:		sprintf(text, "l%i wave", compId);break;
		case kParamLfoMono:			sprintf(text, "l%i mono", compId);break;

		case kParamMasterVolume:	sprintf (text, "master");break;
